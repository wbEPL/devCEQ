...
mod_results_server <- function(id,
  ...
  moduleServer(id, function(input, output, session) {
    ...
    local_mod_ncp_ser(
      ...
      dec_vars = c(
        "dirtax_total_pc", "sscontribs_total_pc", "dirtransf_total_pc", 
        "subsidy_total_pc", "indtax_total_pc", "inktransf_total_pc", "am_CMU_progs_pc"
        
        # "am_total_pc", "am_subCMU_pc", "am_total2_pc", 
        #            "education_inKind_pc", "Sante_inKind_pc", "subsidy_total_pc",
        #            "income_tax_pc", "excise_taxes_pc", "Tax_TVA_pc", "cs_total_pc"
        )
      )
    ...
    local_mod_inc_ser(id = "income_tax", sim_res = sim_res_local,
                          dec_vars = c("dirtax_total_pc", "income_tax_pc", "income_tax_reduc_pc", "trimf_pc"))
    
    # local_mod_inc_ser(id = "excise_taxes", sim_res = sim_res_local,
    #                       dec_vars = c("excise_taxes_pc", "ex_cof_pc", "ex_tea_pc", 
    #                                    "ex_fat1_pc", "ex_fat2_pc", "ex_alc_pc", "ex_nal_pc",
    #                                    "ex_tab_pc"))
    
    local_mod_inc_ser(id = "Tax_TVA", sim_res = sim_res_local,
                          dec_vars = c(
                            "indtax_total_pc", "excise_taxes_pc", "Tax_TVA_pc",  "TVA_direct_pc", "TVA_indirect_pc"))
