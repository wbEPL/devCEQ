...
Most microsimulation analyses are developed in Stata. They have predetermined structure that make such Stata-based tools efficient, transparent, and reproducible. Usually such Stata tool consist of:
